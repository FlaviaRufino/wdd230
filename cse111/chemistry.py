...
def make_periodic_table():
    """Create and return a compound dictionary that maps
    chemical symbols to chemical names and atomic masses.
    """
    periodic_table_dict = {
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    Parameters:
    - symbol_quantity_list: a compound list returned
    ...
    Returns: the total molar mass of all the elements in
